...
1. **[Generating Code For Expressing Simple Preferences: Moving On From Hardcoding And Randomness.](https://computationalcreativity.net/iccc2015/proceedings/1_2Cook.pdf)**
...
1. **[Large dataset and language model fun-tuning for humor recognition](https://aclanthology.org/P19-1394/)**
...
1. **[Humor in Collective Discourse: Unsupervised Funniness Detection in the New Yorker Cartoon Caption Contest](https://aclanthology.org/L16-1076)**
...
1. **[Understanding and Mitigating Compositional Issues in Text-to-Image Generative Models](https://api.semanticscholar.org/CorpusID:270391565)**

    *Arman Zarei, Keivan Rezaei, Samyadeep Basu, Mehrdad Saberi, Mazda Moayeri, Priyatham Kattakinda, Soheil Feizi*

    <u>ArXiv.</u> 2024

1. **[A Comparative Investigation of Compositional Syntax and Semantics in DALL-E 2](https://api.semanticscholar.org/CorpusID:268531835)**

    *Elliot Murphy, Jill Villiers, Sofia Morales*

    <u>ArXiv.</u> 2024

1. **[InstructDiffusion: A Generalist Modeling Interface for Vision Tasks](https://api.semanticscholar.org/CorpusID:261582721)**
...
1. **[T2I-CompBench: A Comprehensive Benchmark for Open-world Compositional Text-to-image Generation](https://api.semanticscholar.org/CorpusID:259847295)**

    *Kaiyi Huang, Kaiyue Sun, Enze Xie, Zhenguo Li, Xihui Liu*

    <u>ArXiv.</u> 2023

1. **[Qualitative Failures of Image Generation Models and Their Application in Detecting Deepfakes](https://api.semanticscholar.org/CorpusID:257826680)**
...
1. **[Draw Your Art Dream: Diverse Digital Art Synthesis with Multimodal Guided Diffusion](https://api.semanticscholar.org/CorpusID:252544936)**
    ...
    *Nisha Huang, Fan Tang, Weiming Dong, Changsheng Xu*
    ...
    <u>Proceedings of the 30th ACM International Conference on Multimedia.</u> 2022

1. **[DALLE-2 is Seeing Double: Flaws in Word-to-Concept Mapping in Text2Image Models](https://api.semanticscholar.org/CorpusID:252992545)**

    *Royi Rassin, Shauli Ravfogel, Yoav Goldberg*

    <u>ArXiv.</u> 2022

1. **[A very preliminary analysis of DALL-E 2](https://api.semanticscholar.org/CorpusID:248476147)**

    *Gary Marcus, Ernest Davis, Scott Aaronson*

    <u>ArXiv.</u> 2022

1. **[Winoground: Probing Vision and Language Models for Visio-Linguistic Compositionality](https://api.semanticscholar.org/CorpusID:248006414)**

    *Tristan Thrush, Ryan Jiang, Max Bartolo, Amanpreet Singh, Adina Williams, Douwe Kiela, Candace Ross*

    <u>2022 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR).</u> 2022

1. **[DALL-E 2 Fails to Reliably Capture Common Syntactic Processes](https://api.semanticscholar.org/CorpusID:253098841)**

    *Evelina Leivada, Elliot Murphy, Gary Marcus*

    <u>ArXiv.</u> 2022

1. **[Testing Relational Understanding in Text-Guided Image Generation](https://api.semanticscholar.org/CorpusID:251224307)**
...
1. **[A Comprehensive Survey on Human Video Generation: Challenges, Methods, and Insights](https://api.semanticscholar.org/CorpusID:271097523)**

    *Wen-Ling Lei, Jinting Wang, Fengji Ma, Guanjie Huang, Li Liu*

    <u>ArXiv.</u> 2024

1. **[VideoPoet: A Large Language Model for Zero-Shot Video Generation](https://api.semanticscholar.org/CorpusID:266435847)**
...
1. **[Photorealistic Video Generation with Diffusion Models](https://api.semanticscholar.org/CorpusID:266163109)**

    *Agrim Gupta, Lijun Yu, Kihyuk Sohn, Xiuye Gu, Meera Hahn, Fei-Fei Li, Irfan Essa, Lu Jiang, Jos{\'e} Lezama*

    <u>ArXiv.</u> 2023

1. **[VideoFusion: Decomposed Diffusion Models for High-Quality Video Generation](https://api.semanticscholar.org/CorpusID:257532642)**

    *Zhengxiong Luo, Dayou Chen, Yingya Zhang, Yan Huang, Liangsheng Wang, Yujun Shen, Deli Zhao, Jinren Zhou, Tien-Ping Tan*

    <u>2023 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR).</u> 2023

1. **[A Survey on Video Diffusion Models](https://api.semanticscholar.org/CorpusID:264172934)**

    *Zhen Xing, Qijun Feng, Haoran Chen, Qi Dai, Hang-Rui Hu, Hang Xu, Zuxuan Wu, Yu-Gang Jiang*

    <u>ArXiv.</u> 2023

1. **[Imagen Video: High Definition Video Generation with Diffusion Models](https://api.semanticscholar.org/CorpusID:252715883)**
...
1. **[Make-A-Video: Text-to-Video Generation without Text-Video Data](https://api.semanticscholar.org/CorpusID:252595919)**
...
1. **[Video Diffusion Models](https://api.semanticscholar.org/CorpusID:248006185)**

    *Jonathan Ho, Tim Salimans, Alexey Gritsenko, William Chan, Mohammad Norouzi, David J. Fleet*

    <u>ArXiv.</u> 2022

1. **[VideoGPT: Video Generation using VQ-VAE and Transformers](https://api.semanticscholar.org/CorpusID:233307257)**

    *Wilson Yan, Yunzhi Zhang, P. Abbeel, A. Srinivas*

    <u>ArXiv.</u> 2021

1. **[ViViT: A Video Vision Transformer](https://api.semanticscholar.org/CorpusID:232417054)**

    *Anurag Arnab, Mostafa Dehghani, Georg Heigold, Chen Sun, Mario Lucic, Cordelia Schmid*

    <u>2021 IEEE/CVF International Conference on Computer Vision (ICCV).</u> 2021

1. **[MoCoGAN: Decomposing Motion and Content for Video Generation](https://api.semanticscholar.org/CorpusID:4475365)**

    *S. Tulyakov, Ming-Yu Liu, Xiaodong Yang, Jan Kautz*

    <u>2018 IEEE/CVF Conference on Computer Vision and Pattern Recognition.</u> 2017

### Musical Creativity
1. **[Chatmusician: Understanding and generating music intrinsically with llm](https://aclanthology.org/2024.findings-acl.373/)**

    *Ruibin Yuan, Hanfeng Lin, Yi Wang, Zeyue Tian, Shangda Wu, Tianhao Shen, Ge Zhang, Yuhang Wu, Cong Liu, Ziya Zhou, others*

    <u>Findings of the Association for Computational Linguistics: ACL 2024</u> 2024

1. **[ComposerX: Multi-Agent Symbolic Music Composition with LLMs](https://arxiv.org/abs/2404.18081)**

    *Qixin Deng, Qikai Yang, Ruibin Yuan, Yipeng Huang, Yi Wang, Xubo Liu, Zeyue Tian, Jiahao Pan, Ge Zhang, Hanfeng Lin, others*

    <u>arXiv preprint arXiv:2404.18081.</u> 2024

1. **[Mupt: A generative symbolic music pretrained transformer](https://arxiv.org/abs/2404.06393)**

    *Xingwei Qu, Yuelin Bai, Yinghao Ma, Ziya Zhou, Ka Man Lo, Jiaheng Liu, Ruibin Yuan, Lejun Min, Xueling Liu, Tianyu Zhang, others*

    <u></u> 2024

1. **[A Survey on Deep Learning for Symbolic Music Generation: Representations, Algorithms, Evaluations, and Challenges](https://doi.org/10.1145/3597493)**

    *Shulei Ji, Xinyu Yang, Jing Luo*

    <u>ACM Comput. Surv. Association for Computing Machinery.</u> 2023

1. **[Between the AI and Me: Analysing Listeners' Perspectives on AI- and Human-Composed Progressive Metal Music](https://api.semanticscholar.org/CorpusID:271571547)**

    *Pedro Sarmento, John H. Loth, Mathieu Barthet*

    <u>ArXiv.</u> 2024

1. **[Simple and Controllable Music Generation](https://api.semanticscholar.org/CorpusID:259108357)**

    *Jade Copet, Felix Kreuk, Itai Gat, Tal Remez, David Kant, Gabriel Synnaeve, Yossi Adi, Alexandre D'efossez*

    <u>ArXiv.</u> 2023

1. **[MusicLM: Generating Music From Text](https://api.semanticscholar.org/CorpusID:256274504)**
...
1. **["A Good Algorithm Does Not Steal - It Imitates": The Originality Report as a Means of Measuring When a Music Generation Algorithm Copies Too Much](https://api.semanticscholar.org/CorpusID:233236232)**
...
1. **[A Comprehensive Survey on Deep Music Generation: Multi-level Representations, Algorithms, Evaluations, and Future Directions](https://api.semanticscholar.org/CorpusID:226956064)**

    *Shulei Ji, Jing Luo, Xinyu Yang*

    <u>ArXiv.</u> 2020

1. **[Pop Music Transformer: Beat-based Modeling and Generation of Expressive Pop Piano Compositions](https://api.semanticscholar.org/CorpusID:220919638)**

    *Yu-Siang Huang, Yi-Hsuan Yang*

    <u>Proceedings of the 28th ACM International Conference on Multimedia.</u> 2020

1. **[MuseNet](https://openai.com/index/musenet/)**

    *OpenAI*

    <u></u> 2019

1. **[LakhNES: Improving Multi-instrumental Music Generation with Cross-domain Pre-training](https://api.semanticscholar.org/CorpusID:195886341)**

    *Chris Donahue, Huanru Henry Mao, Yiting Li, G. Cottrell, Julian McAuley*

    <u>ArXiv.</u> 2019

1. **[A Hierarchical Latent Vector Model for Learning Long-Term Structure in Music](https://api.semanticscholar.org/CorpusID:3891811)**

    *Adam Roberts, Jesse Engel, Colin Raffel, Curtis Hawthorne, Douglas Eck*

    <u>ArXiv.</u> 2018

1. **[Music Transformer: Generating Music with Long-Term Structure](https://api.semanticscholar.org/CorpusID:54477714)**
    ...
    *Cheng-Zhi Anna Huang, Ashish Vaswani, Jakob Uszkoreit, Noam M. Shazeer, Ian Simon, Curtis Hawthorne, Andrew M. Dai, Matthew D. Hoffman, Monica Dinculescu, Douglas Eck*
    ...
    <u>International Conference on Learning Representations.</u> 2018

1. **[On the evaluation of generative models in music](https://api.semanticscholar.org/CorpusID:53258271)**

    *Li-Chia Yang, Alexander Lerch*

    <u>Neural Computing and Applications.</u> 2018

1. **[MidiNet: A Convolutional Generative Adversarial Network for Symbolic-Domain Music Generation](https://api.semanticscholar.org/CorpusID:2002865)**

    *Li-Chia Yang, Szu-Yu Chou, Yi-Hsuan Yang*

    <u>ArXiv.</u> 2017

1. **[MuseGAN: Multi-track Sequential Generative Adversarial Networks for Symbolic Music Generation and Accompaniment](https://api.semanticscholar.org/CorpusID:19098155)**

    *Hao-Wen Dong, Wen-Yi Hsiao, Li-Chia Yang, Yi-Hsuan Yang*

    <u>AAAI Conference on Artificial Intelligence.</u> 2017

1. **[Generating Videos with Scene Dynamics](https://api.semanticscholar.org/CorpusID:9933254)**

    *Carl Vondrick, Hamed Pirsiavash, Antonio Torralba*

    <u>Neural Information Processing Systems.</u> 2016

1. **[Polyphonic music modeling with random fields](https://dl.acm.org/doi/abs/10.1145/957013.957041)**

    *Victor Lavrenko, Jeremy Pickens*

    <u>Proceedings of the eleventh ACM international conference on Multimedia.</u> 2003

1. **[Finding temporal structure in music: Blues improvisation with LSTM recurrent networks](https://ieeexplore.ieee.org/document/1030094)**

    *Douglas Eck, Juergen Schmidhuber*

    <u>Proceedings of the 12th IEEE workshop on neural networks for signal processing.</u> 2002

1. **[Analysis and synthesis of Palestrina-style counterpoint using Markov chains](https://www.researchgate.net/publication/228846096_Analysis_and_Synthesis_of_Palestrina-Style_Counterpoint_Using_Markov_Chains)**

    *Mary Farbood, Bernd Sch{\"o}ner*

    <u>ICMC.</u> 2001

1. **[Experiments in musical intelligence](https://www.tandfonline.com/doi/abs/10.1080/09298218908570541)**

    *David Cope*

    <u>AR editions Madison, WI.</u> 1996

1. **[GenJam: A genetic algorithm for generating jazz solos](https://www.semanticscholar.org/paper/GenJam%3A-A-Genetic-Algorithm-for-Generating-Jazz-Biles/0d8bb76012371d534ae8fcfb779e570ea851c487)**

    *John Biles, others*

    <u>International Conference on Mathematics and Computing.</u> 1994

1. **[A connectionist approach to algorithmic composition](https://ieeexplore.ieee.org/document/6275075)**

    *Peter M Todd*

    <u>Computer Music Journal. JSTOR.</u> 1989

1. **[Automated composition in retrospect: 1956-1986](https://www.jstor.org/stable/1578334)**

    *Charles Ames*

    <u>Leonardo. JSTOR.</u> 1987

1. **[Musical composition with a high-speed digital computer](https://dl.acm.org/doi/10.5555/167765.167769)**

    *Lejaren Hiller, Leonard Isaacson*

    <u></u> 1958

1. **[An experiment in musical composition](https://ieeexplore.ieee.org/document/5222016)**

    *Frederick P Brooks, AL Hopkins, Peter G Neumann, William V Wright*

    <u>IRE Transactions on Electronic Computers. IEEE.</u> 1957

## Scientific Creativity
1. **[Automated Scientific Discovery: From Equation Discovery to Autonomous Discovery Systems](https://api.semanticscholar.org/CorpusID:258461620)**

    *Stefan Kramer, Mattia Cerrato, Saso Dzeroski, Ross D. King*

    <u>ArXiv.</u> 2023

1. **[From Kepler to Newton: Explainable AI for Science Discovery](https://api.semanticscholar.org/CorpusID:244728403)**

    *Zelong Li, Jianchao Ji, Yongfeng Zhang*

    <u>ArXiv.</u> 2021

1. **[Automating scientific discovery](https://dl.acm.org/doi/pdf/10.1145/2160718.2160723)**

    *Neil Savage*

    <u>Communications of the ACM. ACM New York, NY, USA.</u> 2012

1. **[Automating Science](https://www.science.org/doi/abs/10.1126/science.1172781)**
...
1. **[Automated discovery of fundamental variables hidden in experimental data](https://api.semanticscholar.org/CorpusID:251087119)**

    *Boyuan Chen, Kuang Huang, Sunand Raghupathi, Ishaan Preetam Chandratreya, Qi Du, Hod Lipson*

    <u>Nature Computational Science.</u> 2022

1. **[Deep neural networks to recover unknown physical parameters from oscillating time series](https://api.semanticscholar.org/CorpusID:231572959)**

    *Antoine Garcon, Julian Vexler, Dmitry Budker, Stefan Kramer*

    <u>PLoS ONE.</u> 2021

1. **[Discovering Symbolic Models from Deep Learning with Inductive Biases](https://api.semanticscholar.org/CorpusID:219966125)**

    *M. Cranmer, Alvaro Sanchez-Gonzalez, Peter W. Battaglia, Rui Xu, Kyle Cranmer, David N. Spergel, Shirley Ho*

    <u>ArXiv.</u> 2020

1. **[AI Feynman 2.0: Pareto-optimal symbolic regression exploiting graph modularity](https://api.semanticscholar.org/CorpusID:219955930)**

    *S. M. Udrescu, Andrew Yong-Yi Tan, Jiahai Feng, Orisvaldo Neto, Tailin Wu, Max Tegmark*

    <u>ArXiv.</u> 2020

1. **[Deep symbolic regression: Recovering mathematical expressions from data via risk-seeking policy gradients](https://api.semanticscholar.org/CorpusID:212956516)**

    *Brenden K. Petersen, Mikel Landajuela*

    <u>arXiv: Learning.</u> 2019

1. **[Distilling free-form natural laws from experimental data](https://www.science.org/doi/10.1126/science.1165893)**

    *Michael Schmidt, Hod Lipson*

    <u>science. American Association for the Advancement of Science.</u> 2009

1. **[Declarative Bias in Equation Discovery](https://api.semanticscholar.org/CorpusID:7320694)**

    *Ljup Co Todorovski*

    <u></u> 1997

1. **[Genetic programming as a means for programming computers by natural selection](https://api.semanticscholar.org/CorpusID:8750149)**

    *John R. Koza*

    <u>Statistics and Computing.</u> 1994

1. **[Discovering Dynamics](https://api.semanticscholar.org/CorpusID:17202248)**

    *Saso Dzeroski, Ljupco Todorovski*

    <u>International Conference on Machine Learning.</u> 1993

1. **[Scientific discovery: computational explorations of the creative process](https://api.semanticscholar.org/CorpusID:62762320)**

    *George Rzevski, Pat Langley, Herbert A. Simon, Gary L. Bradshaw, Jan M. Zytkow*

    <u></u> 1987

1. **[BACON: A Production System That Discovers Empirical Laws](https://api.semanticscholar.org/CorpusID:2320342)**
...
### Knowledge Discovery
1. **[De novo design of high-affinity protein binders with AlphaProteo](https://arxiv.org/abs/2409.08022)**
...
1. **[Accurate structure prediction of biomolecular interactions with AlphaFold 3](https://doi.org/10.1038/s41586-024-07487-w)**
...
1. **[AlphaProof](https://deepmind.google/discover/blog/ai-solves-imo-problems-at-silver-medal-level/)**

    *Thomas Hubert, Rishi Mehta, Laurent Sartran*

    <u></u> 2024

1. **[Solving olympiad geometry without human demonstrations](https://doi.org/10.1038/s41586-023-06747-5)**

    *Trieu H. Trinh, Yuhuai Wu, Quoc V. Le, He He, Thang Luong*

    <u>Nature.</u> 2024

1. **[Highly accurate protein structure prediction with AlphaFold](https://doi.org/10.1038/s41586-021-03819-2)**
...
1. **[Automated discovery of scientific concepts: Replicating three recent discoveries in mechanics](https://www.sciencedirect.com/science/article/pii/S1474034620300495)**

    *Yaron Hakuk, Yoram Reich*

    <u>Advanced Engineering Informatics.</u> 2020

1. **[Generating conjectures on fundamental constants with the Ramanujan Machine](http://dx.doi.org/10.1038/s41586-021-03229-4)**

    *Gal Raayoni, Shahar Gottlieb, Yahel Manor, George Pisha, Yoav Harris, Uri Mendlovic, Doron Haviv, Yaron Hadad, Ido Kaminer*

    <u>Nature. Springer Science and Business Media LLC.</u> 2021

1. **[Discovering Physical Concepts with Neural Networks](https://link.aps.org/doi/10.1103/PhysRevLett.124.010508)**

    *Raban Iten, Tony Metger, Henrik Wilming, L\'{\i}dia Rio, Renato Renner*

    <u>Phys. Rev. Lett. American Physical Society.</u> 2020

1. **[Toward an artificial intelligence physicist for unsupervised learning](https://arxiv.org/abs/1810.10525)**

    *Tailin Wu, Max Tegmark*

    <u>Physical Review E. APS.</u> 2019

1. **[Automated discovery and proof of congruence theorems for partial sums of combinatorial sequences](https://www.tandfonline.com/doi/full/10.1080/10236198.2016.1142541)**

    *William YC Chen, Qing-Hu Hou, Doron Zeilberger*

    <u>Journal of Difference Equations and Applications. Taylor \& Francis.</u> 2016

1. **[Theorema: Towards computer-aided mathematical theory exploration](https://www.sciencedirect.com/science/article/pii/S1570868305000716)**
    ...
    *Bruno Buchberger, Adrian Crǎciun, Tudor Jebelean, Laura Kovács, Temur Kutsia, Koji Nakagawa, Florina Piroi, Nikolaj Popov, Judit Robu, Markus Rosenkranz, Wolfgang Windsteiger*
    ...
    <u>Journal of Applied Logic.</u> 2006

1. **[On Conjectures of Graffiti](https://www.sciencedirect.com/science/article/pii/S0167506008707763)**

    *Siemion Fajtlowicz*

    <u>Graph Theory and Applications. Elsevier.</u> 1988

1. **[Why AM and EURISKO appear to work](https://www.sciencedirect.com/science/article/abs/pii/000437028490016X)**

    *Douglas B Lenat, John Seely Brown*

    <u>Artificial intelligence. Elsevier.</u> 1984

1. **[Applications of artificial intelligence for organic chemistry: the DENDRAL project](https://books.google.ch/books/about/Applications_of_Artificial_Intelligence.html?id=VY28AAAAIAAJ&redir_esc=y)**
...
1. **[SciMON: Scientific Inspiration Machines Optimized for Novelty](https://arxiv.org/abs/2305.14259)**

    *Qingyun Wang, Doug Downey, Heng Ji, Tom Hope*

    <u></u> 2024

1. **[DiscoveryBench: Towards Data-Driven Discovery with Large Language Models](https://arxiv.org/abs/2407.01725)**
...
1. **[SciAgents: Automating scientific discovery through multi-agent intelligent graph reasoning](https://api.semanticscholar.org/CorpusID:272524655)**

    *Alireza Ghafarollahi, Markus J. Buehler*

    <u></u> 2024

1. **[MLR-Copilot: Autonomous Machine Learning Research based on Large Language Models Agents](https://api.semanticscholar.org/CorpusID:271957477)**

    *Ruochen Li, Teerth Patel, Qingyun Wang, Qingyun Wang, Xinya Du*

    <u></u> 2024

1. **[Autonomous LLM-driven research from data to human-verifiable research papers](https://arxiv.org/abs/2404.17605)**

    *Tal Ifargan, Lukas Hafner, Maor Kern, Ori Alcalay, Roy Kishony*

    <u></u> 2024

1. **[Language agents achieve superhuman synthesis of scientific knowledge](https://paper.wikicrow.ai)**
...
1. **[How AI Processing Delays Foster Creativity: Exploring Research Question Co-Creation with an LLM-based Agent](https://doi.org/10.1145/3613904.3642698)**
...
1. **[Ideas are Dimes a Dozen: Large Language Models for Idea Generation in Innovation](https://api.semanticscholar.org/CorpusID:260467886)**
    ...
    *Karan Girotra, Lennart Meincke, Christian Terwiesch, Karl T. Ulrich*
    ...
    <u>SSRN Electronic Journal.</u> 2023

1. **[Emergent autonomous scientific research capabilities of large language models](https://arxiv.org/abs/2304.05332)**

    *Daniil A. Boiko, Robert MacKnight, Gabe Gomes*

    <u></u> 2023

1. **[Large Language Models are Zero Shot Hypothesis Proposers](https://arxiv.org/abs/2311.05965)**

    *Biqing Qi, Kaiyan Zhang, Haoxiang Li, Kai Tian, Sihang Zeng, Zhang-Ren Chen, Bowen Zhou*

    <u></u> 2023

1. **[Artificial intelligence in scientific writing: a friend or a foe?](https://pubmed.ncbi.nlm.nih.gov/37142479/)**

    *Signe Altmäe, Alberto Sola-Leyva, Andres Salumets*

    <u>Reproductive BioMedicine Online.</u> 2023

1. **[Large Language Models for Automated Open-domain Scientific Hypotheses Discovery](https://api.semanticscholar.org/CorpusID:261557055)**

    *Zonglin Yang, Xinya Du, Junxian Li, Jie Zheng, Soujanya Poria, E. Cambria*

    <u>Annual Meeting of the Association for Computational Linguistics.</u> 2023

1. **[AGATHA: Automatic Graph Mining And Transformer based Hypothesis Generation Approach](https://doi.org/10.1145/3340531.3412684)**

    *Justin Sybrandt, Ilya Tyagin, Michael Shtutman, Ilya Safro*

    <u>Proceedings of the 29th ACM International Conference on Information \& Knowledge Management. Association for Computing Machinery.</u> 2020

1. **[A Bayesian machine scientist to aid in the solution of challenging scientific problems](https://www.science.org/doi/abs/10.1126/sciadv.aav6971)**

    *Roger Guimerà, Ignasi Reichardt, Antoni Aguilar-Mogas, Francesco A. Massucci, Manuel Miranda, Jordi Pallarès, Marta Sales-Pardo*

    <u>Science Advances.</u> 2020

1. **[PaperRobot: Incremental Draft Generation of Scientific Ideas](https://api.semanticscholar.org/CorpusID:159040684)**

    *Qingyun Wang, Lifu Huang, Zhiying Jiang, Kevin Knight, Heng Ji, Mohit Bansal, Yi Luan*

    <u>ArXiv.</u> 2019

1. **[The Automation of Science](https://www.science.org/doi/abs/10.1126/science.1165620)**
...
1. **[Digger: Detecting Copyright Content Mis-usage in Large Language Model Training](https://arxiv.org/abs/2401.00676)**

    *Haodong Li, Gelei Deng, Yi Liu, Kailong Wang, Yuekang Li, Tianwei Zhang, Yang Liu, Guoai Xu, Guosheng Xu, Haoyu Wang*

    <u></u> 2024

1. **[Detecting Pretraining Data from Large Language Models](https://arxiv.org/abs/2310.16789)**

    *Weijia Shi, Anirudh Ajith, Mengzhou Xia, Yangsibo Huang, Daogao Liu, Terra Blevins, Danqi Chen, Luke Zettlemoyer*

    <u></u> 2024

1. **[DE-COP: Detecting Copyrighted Content in Language Models Training Data](https://arxiv.org/abs/2402.09910)**

    *André V. Duarte, Xuandong Zhao, Arlindo L. Oliveira, Lei Li*

    <u></u> 2024

1. **[Disrupting Creativity: Copyright Law in the Age of Generative Artificial Intelligence](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4185327)**

    *Ryan Abbott, Elizabeth Rothman*

    <u>Elsevier.</u> 2023

1. **[The Times Sues OpenAI and Microsoft Over A.I. Use of Copyrighted Work.](https://www.nytimes.com/2023/12/27/business/media/new-york-times-open-ai-microsoft-lawsuit.html)**

    *M. M. Grynbaum, R. Mac*

    <u>New York Times.</u> 2023

1. **[Artists take new shot at Stability, Midjourney in updated copyright lawsuit.](https://www.reuters.com/legal/litigation/artists-take-new-shot-stability-midjourney-updated-copyright-lawsuit-2023-11-30/)**

    *B. Brittain*

    <u>Reuters.</u> 2023

1. **[Diffusion Art or Digital Forgery? Investigating Data Replication in Diffusion Models](https://api.semanticscholar.org/CorpusID:254366634)**

    *Gowthami Somepalli, Vasu Singla, Micah Goldblum, Jonas Geiping, Tom Goldstein*

    <u>2023 IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR).</u> 2023

1. **[Speak, Memory: An Archaeology of Books Known to ChatGPT/GPT-4](https://arxiv.org/abs/2305.00118)**

    *Kent K. Chang, Mackenzie Cramer, Sandeep Soni, David Bamman*

    <u></u> 2023

1. **[Copyright in generative deep learning](https://api.semanticscholar.org/CorpusID:234777751)**

    *Giorgio Franceschelli, Mirco Musolesi*

    <u>Data \& Policy.</u> 2021

1. **[Intellectual Property on Works of Art Made by Artificial Intelligence](https://api.semanticscholar.org/CorpusID:234541178)**

    *Cl{\'a}udio Lisboa Santos, {\^A}ngela Rocha Machado*

    <u>International Journal of Advanced Engineering Research and Science.</u> 2020

1. **[People Not Machines: Authorship and What It Means in the Berne Convention](https://api.semanticscholar.org/CorpusID:158580780)**

    *Jane C. Ginsburg*

    <u>IIC - International Review of Intellectual Property and Competition Law.</u> 2018

1. **[Authorship in the Age of Machine learning and Artificial Intelligence](https://api.semanticscholar.org/CorpusID:69806575)**

    *Jean-Marc Deltorn, Franck Macrez*

    <u>Legal Perspectives in Information Systems eJournal.</u> 2018

1. **[Do Androids Dream of Electric Copyright? Comparative Analysis of Originality in Artificial Intelligence Generated Works](https://api.semanticscholar.org/CorpusID:21670175)**

    *Andres Guadamuz*

    <u>Econometrics: Computer Programs \& Software eJournal.</u> 2017

1. **[Ex Machina: Copyright Protection for Computer-Generated Works](https://api.semanticscholar.org/CorpusID:88486949)**

    *Robert C. Denicola*

    <u>Innovation Law \& Policy eJournal.</u> 2016

1. **[Copyright in computer-composed music: Hal meets Handel](https://www.researchgate.net/publication/294223301_Copyright_in_computer-composed_music_Hal_meets_Handel)**

    *W.T. Ralston*

    <u>Journal of the Copyright Society of the U.S.A.</u> 2005

1. **[COPYRIGHT PROTECTION FOR COMPUTER PROGRAMS, DATABASES, AND COMPUTER-GENERATED WORKS: IS ANYTHING NEW SINCE CONTU?](https://api.semanticscholar.org/CorpusID:141462591)**

    *Arthur R. Miller*

    <u>Harvard Law Review.</u> 1993

1. **[Allocating Ownership Rights in Computer-Generated Works](https://api.semanticscholar.org/CorpusID:142911255)**

    *Pamela Samuelson*

    <u>University of Pittsburgh Law Review.</u> 1986
...
1. **[Locally Typical Sampling](https://aclanthology.org/2023.tacl-1.7/)**
    ...
    *Clara Meister, Tiago Pimentel, Gian Wiher, Ryan Cotterell*
    ...
    <u>Transactions of the Association for Computational Linguistics, Volume 11</u> 2023

1. **[Contrastive Decoding: Open-ended Text Generation as Optimization](https://aclanthology.org/2023.acl-long.687/)**
...
1. **[Enhancing Creativity in Large Language Models through Associative Thinking Strategies](https://api.semanticscholar.org/CorpusID:269756853)**
